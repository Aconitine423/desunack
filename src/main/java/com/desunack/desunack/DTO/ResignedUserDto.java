...
import com.desunack.desunack.Entity.ResignedMemberEntity;
...
public class ResignedUserDto {
    ...
    public ResignedMemberEntity toEntity() {
        return ResignedMemberEntity.builder().rm_num(this.ru_num).rm_m_uid(this.ru_m_uid)
